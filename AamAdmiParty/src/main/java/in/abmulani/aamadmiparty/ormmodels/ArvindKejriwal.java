...
public class Arvindkejriwal extends SugarRecord<Arvindkejriwal> {
    ...
    public Arvindkejriwal(Context context, ResultContent content) {
        super(context);
    ...
    public Arvindkejriwal(Context context) {
        super(context);
    }
