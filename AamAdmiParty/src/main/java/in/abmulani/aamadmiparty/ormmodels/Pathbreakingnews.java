...
public class Pathbreakingnews extends SugarRecord<Pathbreakingnews> {
    ...
    public Pathbreakingnews(Context context, ResultContent content) {
        super(context);
    ...
    public Pathbreakingnews(Context context){
        super(context);
    }
}