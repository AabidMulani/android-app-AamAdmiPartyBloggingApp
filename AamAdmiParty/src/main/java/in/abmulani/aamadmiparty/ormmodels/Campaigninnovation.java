...
public class Campaigninnovation extends SugarRecord<Campaigninnovation> {
    ...
    public Campaigninnovation(Context context, ResultContent content) {
        super(context);
    ...
    public Campaigninnovation(Context context) {
        super(context);
    }
